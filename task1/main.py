...
class FlashcardApp:
    def __init__(self, root):
        ...
        self.label = tk.Label(root, text="", font=("Arial", 16, "bold"), wraplength=400, height=5, width=40, anchor="center", justify="center", relief="groove")
        ...
        tk.Button(self.nav_frame, text="Previous", font=("Helvetica", 12), fg="white", bg="violet", borderwidth=3, activebackground="pink", command=self.prev_card).pack(side=tk.LEFT, padx=10)
        tk.Button(self.nav_frame, text="Next", font=("Helvetica", 12), fg="white", bg="grey", borderwidth=3, activebackground="silver", command=self.next_card).pack(side=tk.LEFT, padx=10)
